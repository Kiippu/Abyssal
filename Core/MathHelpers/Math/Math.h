...
class Math
{
	public:
		...
		static glm::vec3 GetAxis(const InputEventHandler &handler)
		{
			glm::vec3 axis(0.0f);
		...
		static glm::vec3 GetScaleAxis(const InputEventHandler &handler)
		{
			glm::vec3 axis(1.0f);
		...
		static glm::vec3 GetRotationAxis(const InputEventHandler &handler)
		{
